...
class DashboardData(BaseModel):
    total_conversations: int = Field(..., description="Total conversations in the selected period")
    ...
    avg_resolution_seconds: float | None = Field(
...
class CostBreakdown(BaseModel):
    ...
    cost_per_conversation: float | None = Field(
